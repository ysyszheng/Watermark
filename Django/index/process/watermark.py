...
class WatermarkRemover(object):
    ...
    def generate_template_gray_and_mask(self, watermark_template_filename):
        ...
        # 水印模板原图
        print(f"img_path:{watermark_template_filename}")
    ...
    def remove_watermark_raw(
        self, img, watermark_template_gray_img, watermark_template_mask_img
    ):
        """
        去除图片中的水印
        :param img: 待去除水印图片位图
